...
public class OfflineExercises {
	...
	static String a = "TTThhheee";
	static String b = "AAAAAAbbbbbb";
	static String c = "HHHiii---TTThhheeerrreee";
	...
	public static void main(String[] args) {
		...
		for (int i = 0; i < aArray.length; i++) {
			if (aArray[i] == aArray[i + 1] && aArray[i + 1] == aArray[i + 2] && aArray[i + 2] == aArray[i + 3]) {
				removeElement(aArray, i + 1);
				removeElement(aArray, i + 2);
			}
		}
		System.out.println(aArray.toString());
	}

	public static void removeElement(char[] arr, int removedIdx) {
